...
#         )
        ...
        with self.voiceover(text="The Problem to find the shortest way between multiple points is called the Traveling Salesperson Problem (TSP). Alex goal is to keep the distance traveled as low as possible. ") as tracker:
